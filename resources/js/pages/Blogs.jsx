...
const BlogDetail = () => {
  ...
  const relatedPosts = [
    { id: 1, title: 'Trọn Bộ Lãi Suất Vay Mua Nhà Mới Nhất', date: 'Tháng 12/2025' },
    { id: 2, title: 'Nhà Ở Xã Hội Tiếp Tục Tăng Giá Mạnh', date: 'Tháng 11/2025' },
    { id: 3, title: 'A&T Group Chính Thức Khởi Công Chính Trang Tuyến Đường Ven Sông Sài Gòn', date: 'Tháng 11/2025' },
    { id: 4, title: 'Giá Chung Cư Đi Ngang, Lãi Suất Tăng: Nhà Đầu Tư Lướt Sóng Đứng Ngồi Không Yên', date: 'Tháng 11/2025' },
    { id: 5, title: 'Phía Đông Hà Nội Rầm Rộ Đón Nguồn Cung Mới Thời Điểm Cuối Năm', date: 'Tháng 11/2025' }
  ];
          ...
          <div className="blog-detail-meta">
            <div className="author-info">
              ...
              <div className="author-details">
                <p className="author-name">Được đăng bởi <strong>{currentPost.author}</strong></p>
                <p className="post-date">
                  Cập nhật lần cuối vào {currentPost.date} • Đọc trong khoảng {currentPost.readTime}
                </p>
              </div>
            </div>
          </div>
            ...
            <div key={index} className="blog-section">
              ...
              {index === 0 && (
                <div className="blog-featured-image">
                  ...
                  <p className="image-caption">Hình ảnh minh họa</p>
                </div>
              )}
            </div>
          ))}
